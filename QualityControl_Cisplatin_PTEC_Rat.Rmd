---
title: "BOO2024 - QualityControl_Cisplatin_PTEC_Rat"
...
note: a big part of the code is obtained by Leiden University
...
* What is metadata?
```{r}
metadata <- fread(input = file.path(input_dir, "SP0173_rat_cisplatin_metadata2.csv"))
```
...
```{r}
countdata_raw <- fread(input = file.path(input_dir, "SP0173_rat_cisplatin_rawcounts2.csv"))
```
...
# Load fonts (make sure Noto Sans is installed on your system)
...
ggplot(data = size, mapping = aes(x = SAMPLE_ID, y = SAMPLE_SIZE, fill = SAMPLE_SIZE < countdata_threshold)) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle= 45, vjust=1, hjust=1, size = 9, family = "noto_sans", face = "bold")
        ) +
...
countdata_raw_fsample_fprobe = countdata_raw_fsample %>% filter(!GENE_SYMBOL %in% low_cpm_probes)
  ...
  write.csv(low_cpm_probes, file = "removed_probes_NienkeRat2.csv", row.names = FALSE)
```
...
order <- c( "RPPTEC_NaCl_8hr_0.9",  "RPPTEC_CSP_8hr_2.5",   "RPPTEC_CSP_8hr_10",   
 "RPPTEC_CSP_8hr_50",    "RPPTEC_NaCl_24hr_0.9", "RPPTEC_CSP_24hr_2.5", 
 "RPPTEC_CSP_24hr_10",   "RPPTEC_CSP_24hr_50",   "RPPTEC_NaCl_72hr_0.9",
"RPPTEC_CSP_72hr_2.5",  "RPPTEC_CSP_72hr_10",   "RPPTEC_CSP_72hr_50")
...
# Mean correlation for each condition
mean_correlations <- correlation_data %>%
  group_by(MEAN_ID) %>%
  summarise(mean_correlation = mean(Freq))
...
```{r error=F,warning=F,message=F}
order <- c("S_0.9pc_NaCl_8_h_P4", "S_2.5_uM_Cisplatin_8_h_P4", "S_10_uM_Cisplatin_8_h_P4", "S_50_uM_Cisplatin_8_h_P4", 
           "S_0.9pc_NaCl_24_h_P4", "S_2.5_uM_Cisplatin_24_h_P4", "S_10_uM_Cisplatin_24_h_P4", "S_50_uM_Cisplatin_24_h_P4",
           "S_0.9pc_NaCl_72_h_P4", "S_2.5_uM_Cisplatin_72_h_P4", "S_10_uM_Cisplatin_72_h_P4", "S_50_uM_Cisplatin_72_h_P4", 
           "S_0.9pc_NaCl_8_h_P5", "S_2.5_uM_Cisplatin_8_h_P5", "S_10_uM_Cisplatin_8_h_P5", "S_50_uM_Cisplatin_8_h_P5",
          "S_0.9pc_NaCl_24_h_P5", "S_2.5_uM_Cisplatin_24_h_P5", "S_10_uM_Cisplatin_24_h_P5", "S_50_uM_Cisplatin_24_h_P5",
           "S_0.9pc_NaCl_72_h_P5", "S_2.5_uM_Cisplatin_72_h_P5", "S_10_uM_Cisplatin_72_h_P5", "S_50_uM_Cisplatin_72_h_P5",
         "S_0.9pc_NaCl_8_h_P6", "S_2.5_uM_Cisplatin_8_h_P6", "S_10_uM_Cisplatin_8_h_P6", "S_50_uM_Cisplatin_8_h_P6", 
           "S_0.9pc_NaCl_24_h_P6", "S_2.5_uM_Cisplatin_24_h_P6", "S_10_uM_Cisplatin_24_h_P6", "S_50_uM_Cisplatin_24_h_P6",
           "S_0.9pc_NaCl_72_h_P6", "S_2.5_uM_Cisplatin_72_h_P6", "S_10_uM_Cisplatin_72_h_P6", "S_50_uM_Cisplatin_72_h_P6"  )
...
# Order treatment conditions
order <- c("S_0.9pc_NaCl_8_h_P4", "S_2.5_uM_Cisplatin_8_h_P4", "S_10_uM_Cisplatin_8_h_P4", "S_50_uM_Cisplatin_8_h_P4", 
           "S_0.9pc_NaCl_24_h_P4", "S_2.5_uM_Cisplatin_24_h_P4", "S_10_uM_Cisplatin_24_h_P4", "S_50_uM_Cisplatin_24_h_P4",
           "S_0.9pc_NaCl_72_h_P4", "S_2.5_uM_Cisplatin_72_h_P4", "S_10_uM_Cisplatin_72_h_P4", "S_50_uM_Cisplatin_72_h_P4", 
           "S_0.9pc_NaCl_8_h_P5", "S_2.5_uM_Cisplatin_8_h_P5", "S_10_uM_Cisplatin_8_h_P5", "S_50_uM_Cisplatin_8_h_P5",
           "S_0.9pc_NaCl_24_h_P5", "S_2.5_uM_Cisplatin_24_h_P5", "S_10_uM_Cisplatin_24_h_P5", "S_50_uM_Cisplatin_24_h_P5",
           "S_0.9pc_NaCl_72_h_P5", "S_2.5_uM_Cisplatin_72_h_P5",  
           "S_0.9pc_NaCl_8_h_P6", "S_2.5_uM_Cisplatin_8_h_P6", "S_10_uM_Cisplatin_8_h_P6", "S_50_uM_Cisplatin_8_h_P6", 
           "S_0.9pc_NaCl_24_h_P6", "S_2.5_uM_Cisplatin_24_h_P6", "S_10_uM_Cisplatin_24_h_P6", "S_50_uM_Cisplatin_24_h_P6",
           "S_0.9pc_NaCl_72_h_P6", "S_2.5_uM_Cisplatin_72_h_P6", "S_10_uM_Cisplatin_72_h_P6")

# Correlation matrix 
correlation_matrix <- correlate(countdata_cpm_fsample_fprobe_sumprobe, diagonal = 1, quiet = TRUE) %>%
...
```{r}
# Save your countdata
write_csv(countdata_raw_fsample_fprobe_sumprobe, file.path(output_dir, paste0(gsub( "-", "", Sys.Date()), "_countdata_raw_processedRat2.csv"))) 

# Save your metadata
write_csv(metadata_fsample, file.path(output_dir, paste0(gsub( "-", "", Sys.Date()), "_metadata_processedRat2.csv"))) 
```
