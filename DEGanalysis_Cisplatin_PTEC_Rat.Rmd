---
title: "BOO2024 - DEGanalysis_Cisplatin_PTEC_Rat"
...
```{r}
metadata = fread(file.path(input_dir, "20240603_metadata_processedRat2.csv"))
...
```{r}
countdata_raw = fread(file.path(input_dir, "20240603_countdata_raw_processedRat2.csv"))
...
order <- c(   "RPPTEC_CSP_8hr_2.5",   "RPPTEC_CSP_8hr_10",   
 "RPPTEC_CSP_8hr_50",    "RPPTEC_CSP_24hr_2.5", 
 "RPPTEC_CSP_24hr_10",   "RPPTEC_CSP_24hr_50",   
